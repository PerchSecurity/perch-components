...
SortableHeaderCell.propTypes = {
  ...
  padding: _propTypes2.default.string.isRequired,
  sortColumn: _propTypes2.default.string.isRequired,
  sortDirection: _propTypes2.default.string.isRequired,
...
var BaseTable = function BaseTable(_ref3) {
  ...
  return _react2.default.createElement(
    ...
    (searchable || actions) && _react2.default.createElement(
      ...
      searchable && _react2.default.createElement(_.SearchBar, { onChange: onSearch, debounce: 1000, classes: { searchBar: classes.searchBar } }),
      actions && _react2.default.createElement(_.ActionBar, { actions: actions, classes: { actionBar: classes.actionBar } })
    ),
    _react2.default.createElement(
      _Table2.default,
      null,
