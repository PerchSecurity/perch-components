...
var getPaginationForData = function getPaginationForData(data) {
  return data && data.total_count > 0 ? {
    count: data.total_count,
    rowsPerPage: data.page_size,
    page: data.page_number,
    onChangePage: undefined.handleChangePage
  } : null;
};
...
var AutoTable = function (_React$Component) {
  ...
  function AutoTable(props) {
    ...
    _this.getTableBodyForResult = function (_ref2) {
      ...
      if (data) {
        ...
        return [].concat(_toConsumableArray(Array(maxRows || 1))).map(function (_, index) {
      ...
      handleSort = function handleSort(column, direction) {
  ...
  _createClass(AutoTable, [{
    ...
    value: function render() {
      ...
      var variables = _extends({}, filter, { size: maxRows, ordering: ordering, page: page, search: search });
