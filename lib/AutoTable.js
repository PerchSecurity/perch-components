    ...
    value: function render() {
      ...
      if (multiselectable) {
        ...
        var multiselectColumn = {
          key: 'select all',
          label: _react2.default.createElement(_materialUi.Checkbox, { onChange: this.handleSelectAll, checked: isAllSelected })
        };
        tableColumns = [multiselectColumn].concat(_toConsumableArray(tableColumns));
      }
      ...
      var tableActions = multiselectActions.map(function (_ref2) {
        ...
        return _extends({}, props, {
          onClick: function onClick() {
            _onClick([].concat(_toConsumableArray(selectedItems)));
          }
        });
      });
      ...
      return _react2.default.createElement(
        ...
        function (result) {
          return _react2.default.createElement(
            ...
            _this2.getTableBodyForResult(result, variables, multiselectable)
          );
        }
      );
    }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getTableBodyForResult = function (_ref4, variables, multiselectable) {
    var data = _ref4.data,
        error = _ref4.error,
    ...
    if (error) {
      ...
      return data.results.map(function (item) {
        var cells = renderItem(item, { data: data, refetch: refetch, variables: variables });
        return _react2.default.createElement(
          _materialUi.TableRow,
          null,
  ...
  this.handleSort = function (column, direction) {
    ...
    _this3.changeTableVariables({ ordering: ordering, sortColumn: column, sortDirection: direction });
  };
