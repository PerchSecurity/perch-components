      ...
      return _react2.default.createElement(
        ...
        function (result) {
          return _react2.default.createElement(
            ...
            _this2.getTableBodyForResult(result, variables)
          );
        }
      );
    }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getTableBodyForResult = function (_ref3, variables) {
    var data = _ref3.data,
        error = _ref3.error,
    ...
    if (error) {
      ...
      return children(data, { refetch: refetch, variables: variables });
    }
