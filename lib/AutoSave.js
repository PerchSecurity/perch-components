...
var AutoSave = function (_React$Component) {
  ...
  function AutoSave() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AutoSave.__proto__ || Object.getPrototypeOf(AutoSave)).call.apply(_ref, [this].concat(args))), _this), _this.saveForm = (0, _lodash.debounce)(_this.context.formik.submitForm, DEBOUNCE_DURATION), _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AutoSave, [{
    ...
    value: function componentWillReceiveProps(nextProps, nextContext) {
      ...
      var valuesHaveChanged = !(0, _lodash.isEqual)(newValues, oldValues);
