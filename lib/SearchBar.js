...
var SearchBar = function (_React$Component) {
  ...
  function SearchBar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SearchBar.__proto__ || Object.getPrototypeOf(SearchBar)).call.apply(_ref, [this].concat(args))), _this), _this.debouncedOnChange = (0, _lodash.debounce)(_this.props.onChange, DEBOUNCE_DURATION), _temp), _possibleConstructorReturn(_this, _ret);
  }
